    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DesirableDestinations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DesirableDestinations_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DesirableDestinations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyRequestId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Offers_TravelCompanies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyRequests_IsDeleted",
                table: "CompanyRequests",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DesirableDestinations_CountryId",
                table: "DesirableDestinations",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_DesirableDestinations_IsDeleted",
                table: "DesirableDestinations",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_DesirableDestinations_UserId",
                table: "DesirableDestinations",
                column: "UserId");
