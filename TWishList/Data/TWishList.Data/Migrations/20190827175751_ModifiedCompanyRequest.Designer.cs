...
namespace TWishList.Data.Migrations
{
    ...
    [Migration("20190827175751_ModifiedCompanyRequest")]
    partial class ModifiedCompanyRequest
    {
            ...
            modelBuilder.Entity("TWishList.Data.Models.CompanyRequest", b =>
                {
                    ...
                    b.Property<string>("CompanyLiablePerson")
                        .IsRequired();
                    ...
                    b.Property<string>("CompanyUniqueIdentifier")
                        .IsRequired();
            ...
            modelBuilder.Entity("TWishList.Data.Models.TravelCompany", b =>
                {
                    b.HasOne("TWishList.Data.Models.CompanyRequest", "CompanyRequest")
                        .WithOne("TravelCompany")
                        .HasForeignKey("TWishList.Data.Models.TravelCompany", "RequestId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
